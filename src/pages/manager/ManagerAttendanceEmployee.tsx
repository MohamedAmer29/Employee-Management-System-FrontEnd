...
import { useManagerEmployeeAttendance } from "@/features/attendance/attendance.hooks";
...
const ManagerAttendanceEmployee = () => {
  ...
  const {
    ...
    isError,
    refetch,
  } = useManagerEmployeeAttendance(employeeId);
...
export default ManagerAttendanceEmployee;
