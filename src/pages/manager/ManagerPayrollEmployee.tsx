...
import { useManagerPayrollEmployee } from "@/features/payroll/payroll.hooks";
...
const ManagerPayrollEmployee = () => {
  ...
  const { data: records = [], isLoading, isError, refetch } = useManagerPayrollEmployee(
    employeeId ?? "",
    params,
    !!employeeId,
  );
...
export default ManagerPayrollEmployee;
