...
const AuthLayout = ({
  ...
  const [displayMode, setDisplayMode] = useState<"login" | "register">(
    initialMode,
  );
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center p-2 sm:p-4 md:p-6 bg-[#E3F2FD] dark:bg-[#0A1C33]">
      <div
